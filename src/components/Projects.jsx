...
const prevProject = ()=>{
  ...
  return (
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <p className='text-center text-gray-500 mb-8 max-w-800 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, dignissimos, ratione assumenda, iste praesentium autem veritatis quas commodi omnis consequatur labore? Suscipit, eligendi? Harum itaque cupiditate fugit suscipit odio pariatur!</p>
