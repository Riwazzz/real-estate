...
const Testimonials = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-800 mx-auto'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque ea laboriosam id dolorum voluptate. Illum neque totam harum sed dolor illo ex officia ullam placeat, temporibus rem possimus eligendi nisi?</p>
